...
<form class="layui-form" action="${requestScope.action}" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="ordernum" value="${requestScope.productDB.productnum}" placeholder="请输入产品编号" required  lay-verify="required" autocomplete="off" class="layui-input">
        </div>
    </div>
